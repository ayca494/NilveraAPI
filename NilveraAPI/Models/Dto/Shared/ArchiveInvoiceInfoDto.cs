...
{
    public class ArchiveInvoiceInfoDto
    {
        ...
        public decimal? ExchangeRate { get; set; }  //Invoice Profile Manuel EArchive Olarak  Basılacak 
        ...
        public bool ISDespatch { get; set; } = false;
        public SalesPlatform? SalesPlatform { get; set; }
        public SendType? SendType { get; set; }
        public InternetInfoDto InternetInfo { get; set; }
