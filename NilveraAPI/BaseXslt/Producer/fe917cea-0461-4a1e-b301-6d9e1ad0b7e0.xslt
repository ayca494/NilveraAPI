						...
						<tbody>
							<tr valign="top">
								...
								<td width="35%" style="vertical-align:middle">
								    <div id="qrcode" style="margin-left:auto;margin-right:auto; display:table" ></div>
							...
							<tr style="height:118px; " valign="top">
							    <td width="40%">
							        ...
							        <table align="center" border="0" width="100%">
							            <tbody>
							                ...
							                <xsl:if
							                    test="//n1:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:Telephone or //n1:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:Telefax">
							                    <tr align="left">
							                ...
							                <xsl:for-each
							                    select="//n1:CreditNote/cac:AccountingCustomerParty/cac:Party/cbc:WebsiteURI">
							                    <tr align="left">
							                        <td>
							                            <xsl:text>Web Sitesi: </xsl:text>
							                            <xsl:value-of select="."/>
							                ...
							                <xsl:for-each
							                    select="//n1:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:ElectronicMail">
							                    <tr align="left">
							                        <td>
							                            <xsl:text>E-Posta: </xsl:text>
							                            <xsl:value-of select="."/>
							                ...
							                <xsl:for-each
							                    select="//n1:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification">
							                    <tr align="left">
							                        <td>
							                            <xsl:value-of select="cbc:ID/@schemeID"/>
							                            <xsl:text>: </xsl:text>
								...
								<td width="25%"></td>
							    <td width="35%" align="center" valign="bottom" colspan="2">
									<table class="despatchTable">
										<tbody>
											<tr>
