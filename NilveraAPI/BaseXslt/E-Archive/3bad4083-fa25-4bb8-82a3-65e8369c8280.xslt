		...
		<html>
			<head>
				<style type="text/css">
					...
					.sgkTable > tbody > tr > td{
					border:1px solid #ccc;
					padding:4px
					}

					.sgkTable > tbody > tr > td:first-child{
					font-weight:bold
					}
			...
			<body
						...
						<tbody>
							...
							<tr style="height:118px; " valign="top">
								...
								<td width="20%" style="text-align:center; vertical-align:middle">
									<img src='data:image/png;base64,'/>
									<!--İmza Alanı-->
								</td>
							...
							<xsl:if test="n1:Invoice/cbc:InvoiceTypeCode = 'SGK'">
								<tr>
									<table class="sgkTable" style="margin-top:10px" >
										<tbody>
											<tr>
												<td>Sağlık Fatura Tipi </td>
												<td>
											...
											<tr>
												<td>Mükellef Kodu </td>
												<td>
													<xsl:for-each select="//n1:Invoice/cac:AdditionalDocumentReference[cbc:DocumentTypeCode = 'MUKELLEF_KODU']">
											...
											<tr>
												<td>Mükellef Adı </td>
												<td>
													<xsl:for-each select="//n1:Invoice/cac:AdditionalDocumentReference[cbc:DocumentTypeCode = 'MUKELLEF_ADI']">
														<xsl:value-of select="cbc:DocumentType"/>
													</xsl:for-each>
												</td>
											</tr>
											<tr>
												<td>Dosya No </td>
												<td>
													<xsl:for-each select="//n1:Invoice/cac:AdditionalDocumentReference[cbc:DocumentTypeCode = 'DOSYA_NO']">
														<xsl:value-of select="cbc:DocumentType"/>
													</xsl:for-each>
												</td>
											</tr>
											<tr>
												...
												<td>
													...
													<xsl:call-template name="DateDMY">
							...
							<table id="lineTable" style="width:470px; float:left">
								<tbody>
									<tr style="border-top:1px solid #ccc">
										<td colspan="2" style="text-align:center;padding:4.5px">
				...
				<xsl:if test="n1:Invoice/cac:DespatchDocumentReference">
					...
					<table id="notesTable" width="800" align="left" style="padding:10px 0px">
						<tbody>
							<tr>
								<td>
									<b>İrsaliye No / Tarih : </b>
									<xsl:for-each select="n1:Invoice/cac:DespatchDocumentReference">
				...
				<div id="eArsivAlan" style="margin-top:10px">
					...
					<div id="elektronikOrtamDogrula" style="width:800px" >
						<div style="width:auto; margin-bottom:10px; margin-top:3px">
							Bu faturayı elektronik olarak görmek ve doğrulamak için <a target="_blank" style="font-weight:bold" href="https://ebelge.gib.gov.tr/earsivsorgula.html">
								<u>ebelge.gib.gov.tr</u>
